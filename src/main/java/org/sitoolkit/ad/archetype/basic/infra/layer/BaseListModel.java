...
import org.sitoolkit.ad.archetype.basic.infra.JSFUtils;
import org.sitoolkit.ad.archetype.basic.infra.code.FlagVo;
import org.sitoolkit.ad.archetype.basic.infra.search.SearchConditionDo;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

/**
 * このクラスは、一覧画面のモデルが継承する基底クラスです。
 * 
 * @author yuichi.kuwahara
 */
public abstract class BaseListModel<E extends BaseEntity, I extends Serializable, S extends BaseService<E, I>> {
     ...
     */
    @Inject
    private SearchConditionDo condition;
    ...
    public String search() {
        ...
        conversation.begin();
        getCondition().init();
        getCondition().getParams().put("eq_deletedFlg", FlagVo.No.getFlag());
